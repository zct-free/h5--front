...
const routes = [
  ...
  },
  {
    ...
    title: "个人中心--考试2",
    component: () => import("@/views/personal-center/examination/test/index.vue"),
  },
  {
    path: "/personal-center/examination2/detail",
    name: "考试详情",
    component: () => import("@/views/personal-center/examination/test/detail.vue"),
  },
  {
    path: "/403",
    name: "Forbidden",
  ...
  // 个人中心--任务--积分明细
  {
    ...
    title: "个人中心--任务--积分明细",
    component: () => import("@/views/personal-center/task/IntegralDetails.vue"),
  },
  {
    path: "/credit-rank",
    name: "CreditRank",
...
router.beforeResolve((to, from, next) => {
  if (
    ...
    to.path !== "/download" &&
    to.path !== "/app-agreement" &&
    to.path !== "/app-agreement-sdk" &&
    to.path !== "/copyright"
  ) {
