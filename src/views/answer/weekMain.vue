<template>
    <div class="answerMain" v-if="!loading" v-finger:swipe="swipeHandler">
        ...
        <End v-else :confing="endConfig" @reMain="reMain" type="WEEKLY"/>
    </div>
        ...
        async next() {
            ...
            if (this.nowIdnex + 1 === this.questions.length) {
                ...
                if (res.data.code == 1000) {
                    const { point,isFirst,upperLimit} = res.data.data;
                    this.mainShow = false;
                ...
                this.myAnswers = [];
                this.nowIdnex++;
                // console.log('finshedIndexfinshedIndex',this.finshedIndex,this.nowIdnex,this.watchIng)
                //  if(this.finshedIndex >= this.nowIdnex){
                //     console.log('next查看中')
                //     this.watchIng = true;
                //  }else {
                //     this.watchIng = false;
